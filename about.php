...
<section>
	        				 ...
	        				 <nav class="navbar navbar-default nav-all">
									    ...
									    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										      <ul class="nav navbar-nav">
										        ...
										        <li class="active all-active"><a href="about.php">ABOUT US</a></li>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 padding-zero">
			 	<img src="assets/image/about-banner.png" class="inside-banner">
			 	<h3 class="title-inside">About Rox Cafe</h3>
			</div>
		</div>
		<div class="row margin-top	">
			<div class="col-xs-12 col-sm-12 col-md-12 padding-zero content-aboutinside">
